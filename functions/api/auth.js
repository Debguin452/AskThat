...
// GET — verify a token (uses shared verifyToken which handles JSON format correctly)
...
// POST — blocked: all account creation goes through the dashboard CF Function
